...
Adding Swift Package Manager integration...                        24.3s
...
↳
    Writing result bundle at path:
    	/var/folders/mn/js5hmsy13552y330w_94s79h0000gn/T/flutter_tools.tuP6Hk/flutter_ios_build_temp_dir2GnpbJ/temporary_xcresult_bundle
    ...
    lib/screens/torrent_tab.dart:92:11: Error: The method '_buildGlassButton' isn't defined for the type '_TorrentTabState'.
     - '_TorrentTabState' is from 'package:dirxplore/screens/torrent_tab.dart' ('lib/screens/torrent_tab.dart').
    Try correcting the name to the name of an existing method, or defining a method named '_buildGlassButton'.
              _buildGlassButton(
              ^^^^^^^^^^^^^^^^^
    lib/screens/torrent_tab.dart:957:11: Error: No named parameter with the name 'customContent'.
              customContent: Column(
              ^^^^^^^^^^^^^
    lib/screens/torrent_tab.dart:1312:11: Error: No named parameter with the name 'customContent'.
              customContent: Column(
              ^^^^^^^^^^^^^
    lib/screens/torrent_tab.dart:1580:49: Error: The method 'toLowerCase' isn't defined for the type 'TorrentFileModel'.
     - 'TorrentFileModel' is from 'package:dtorrent_task_v2/src/torrent/torrent_file_model.dart' ('../../../.pub-cache/hosted/pub.dev/dtorrent_task_v2-0.4.8/lib/src/torrent/torrent_file_model.dart').
    Try correcting the name to the name of an existing method, or defining a method named 'toLowerCase'.
                                            e.value.toLowerCase().contains(RegExp(r'\.(mp4|mkv|avi|mov)$'))
                                                    ^^^^^^^^^^^
    lib/screens/torrent_tab.dart:1630:11: Error: No named parameter with the name 'torrentId'.
              torrentId: id,
              ^^^^^^^^^
    lib/screens/media_player_screen.dart:17:9: Context: Found this candidate, but the arguments don't match.
